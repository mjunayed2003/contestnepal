            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-purple-50 text-purple-600 border border-purple-100 px-2.5 py-1 rounded-md text-[11px] font-bold flex items-center gap-1.5 uppercase tracking-wide">
            ...
            <div className="mt-8 pt-7 border-t border-gray-100">
              ...
              {contest.winnerDeclared && contest.winner && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  {/* Winner Card */}
                  <div className="border border-gray-200 rounded-2xl p-5 sm:p-6 max-w-[500px] mx-auto bg-white shadow-sm">
