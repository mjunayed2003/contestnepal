        ...
        <CardContent className="pt-5 pb-5">
          <div className="flex items-center gap-5">
            <div className="relative">
              <div className="w-20 h-20 rounded-2xl bg-[#A01C1C]/10 flex items-center justify-center border-2 border-[#A01C1C]/20 overflow-hidden">
                <span className="text-3xl font-black text-[#A01C1C]">J</span>
              </div>
              <button
